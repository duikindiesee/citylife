...
// transitTick is private, so intersecting it with ColonyRuntime collapses the type to `never`
// (TS2339). Reach it structurally instead. (Ported from PR #361 during the main cutover.)
