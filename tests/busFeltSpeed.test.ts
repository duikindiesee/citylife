...
// comparable. The original reading of that report blamed the bus alone and would have raised it to
...
describe("spec 163 — the bus is meaningfully faster than the player at their best", () => {
  ...
  it("stays a city bus and not a missile", () => {
    // The raise is bounded ABOVE too: spec 162's reading of this report would have gone to 84
