...
const warmWood = material("Office_Warm_Wood", 0x8a6a48, {
  roughness: 0.68,
  metalness: 0.04,
});
const darkWood = material("Office_Dark_Wood", 0x5c4632, {
  roughness: 0.74,
  metalness: 0.03,
});
const blackIron = material("Office_Black_Iron", 0x424b4b, {
  roughness: 0.36,
  metalness: 0.82,
});
const oldBrass = material("Office_Old_Brass", 0x927747, {
  roughness: 0.43,
  metalness: 0.9,
});
const obsidian = material("Office_Obsidian_Panel", 0x27383c, {
  roughness: 0.34,
  metalness: 0.62,
});
...
const seatFabric = material("Office_Seat_Fabric", 0x6d7a6f, {
  roughness: 0.88,
  metalness: 0.02,
});
const cardPaper = material("Office_Card_Paper", 0xd9cfb8, {
  roughness: 0.92,
  metalness: 0.0,
});
...
const foliage = material("Office_Foliage", 0x3f7d44, {
  roughness: 0.92,
  metalness: 0.0,
});
...
mesh(
  "Chair_Back",
  new THREE.BoxGeometry(0.46, 0.45, 0.06),
  seatFabric,
  chair,
  [0, 0.725, -0.245],
);
...
mesh(
  "Board_Screen",
  new THREE.BoxGeometry(2.84, 1.5, 0.02),
  boardGlow,
  board,
  [0, 0.85, 0.09],
);
for (let lane = 0; lane < 3; lane += 1) {
  mesh(
    `Board_Lane_${lane}`,
    new THREE.BoxGeometry(0.04, 1.4, 0.015),
    blackIron,
    board,
...
mesh(
  "Card_Body",
  new THREE.BoxGeometry(0.6, 0.4, 0.025),
  cardPaper,
  card,
  [0, 0.2, 0.0125],
);
mesh(
  "Card_Tag",
  new THREE.BoxGeometry(0.6, 0.07, 0.015),
  oldBrass,
  card,
  [0, 0.365, 0.0325],
);
...
mesh(
  "Totem_Column",
  new THREE.BoxGeometry(0.34, 2.2, 0.34),
  obsidian,
  totem,
  [0, 1.1, 0],
);
...
mesh(
  "DoorLight_Housing",
  new THREE.BoxGeometry(0.35, 0.14, 0.06),
  blackIron,
  doorLight,
  [0, 0.07, 0.03],
);
mesh(
  "DoorLight_Lens",
  new THREE.BoxGeometry(0.27, 0.08, 0.04),
  totemBand,
  doorLight,
  [0, 0.07, 0.08],
);
...
mesh(
  "Shelf_Back",
  new THREE.BoxGeometry(1.2, 1.8, 0.03),
  darkWood,
  shelf,
  [0, 0.9, 0.015],
);
...
for (let i = 0; i < 3; i += 1) {
  mesh(
    `Shelf_Board_${i}`,
    new THREE.BoxGeometry(1.1, 0.035, 0.32),
    warmWood,
    shelf,
    [0, 0.35 + i * 0.6, 0.175],
  );
...
mesh(
  "Liaison_Front",
  new THREE.BoxGeometry(1.2, 0.55, 0.05),
  obsidian,
  liaison,
  [0, 0.425, 0.22],
);
...
mesh(
  "Routing_Screen",
  new THREE.BoxGeometry(1.44, 0.9, 0.02),
  boardGlow,
  routing,
  [0, 0.55, 0.07],
);
...
mesh(
  "Bench_Vice",
  new THREE.BoxGeometry(0.24, 0.15, 0.18),
  oldBrass,
  bench,
  [0.6, 0.975, 0.2],
);
