...
const wallPlaster = material("Shell_Wall_Plaster", 0x39424e, {
  roughness: 0.9,
  metalness: 0.02,
});
const blackIron = material("Shell_Black_Iron", 0x424b4b, {
  roughness: 0.36,
  metalness: 0.82,
});
const oldBrass = material("Shell_Old_Brass", 0x927747, {
  roughness: 0.43,
  metalness: 0.9,
});
...
const floorSlab = material("Shell_Floor_Slab", 0x2a3038, {
  roughness: 0.95,
  metalness: 0.01,
});
const stripePaint = material("Shell_Stripe_Paint", 0x6d7a6f, {
  roughness: 0.8,
  metalness: 0.02,
});
const planterWood = material("Shell_Planter_Wood", 0x5c4632, {
  roughness: 0.75,
  metalness: 0.03,
});
const foliage = material("Shell_Foliage", 0x3f7d44, {
  roughness: 0.92,
  metalness: 0.0,
});
...
mesh(
  "Wall_Slab",
  new THREE.BoxGeometry(1.0, 2.9, 0.12),
  wallPlaster,
  wall,
  [0, 1.45, 0],
);
mesh(
  "Wall_Skirt",
  new THREE.BoxGeometry(1.0, 0.1, 0.12),
  blackIron,
  wall,
  [0, 2.95, 0],
);
...
mesh(
  "Door_Lintel",
  new THREE.BoxGeometry(2.2, 0.15, 0.16),
  oldBrass,
  door,
  [0, 2.575, 0],
);
...
mesh(
  "Glass_Rail_Bottom",
  new THREE.BoxGeometry(1.0, 0.12, 0.1),
  blackIron,
  pane,
  [0, 0.06, 0],
);
mesh(
  "Glass_Sheet",
  new THREE.BoxGeometry(1.0, 2.7, 0.05),
  glass,
  pane,
  [0, 1.47, 0],
);
mesh(
  "Glass_Rail_Top",
  new THREE.BoxGeometry(1.0, 0.18, 0.1),
  blackIron,
  pane,
  [0, 2.91, 0],
);
...
mesh(
  "Stripe_Paint",
  new THREE.BoxGeometry(1.0, 0.02, 0.3),
  stripePaint,
  stripe,
  [0, 0.01, 0],
);
...
mesh(
  "Nook_Cabinet",
  new THREE.BoxGeometry(0.8, 2.0, 0.55),
  blackIron,
  nook,
  [0, 1.0, 0.275],
);
...
mesh(
  "Nook_Vent",
  new THREE.BoxGeometry(0.7, 0.25, 0.03),
  wallPlaster,
  nook,
  [0, 1.85, 0.585],
);
