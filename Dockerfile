...
#   KOOKER_GATEWAY        - base URL of the kooker gateway the SPA's /kooker calls proxy to
...
ENV NGINX_ENVSUBST_FILTER='^(KOOKER_GATEWAY|CITYLIFE_PAT|CITYLIFE_BOT_BACKEND|CITYLIFE_MODEL)$'
