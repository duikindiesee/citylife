# hq-commons-pack.glb — provenance and license

- **Asset:** `public/assets/citylife/props/hq-commons-pack.glb` — eight commons/arcade parts (watercooler, foosball, arcade cabinet, couch, bean bag, fleet board, snack shelf, rug), for the
...
- **Generator (single source of truth):** `scripts/generate_hq_commons_pack.mjs` — deterministic
  ...
  contract is `tests/hqCommonsPackGlb.test.ts`; placement/module metadata is
  `public/assets/citylife/props/hq-commons-pack.placement.json`.
