...
test("Builds a road, waits for a house to spawn, and explores in First Person", async ({
  page,
}) => {
  ...
  console.log(
    "Road network built. Waiting 10 seconds for neighborhood simulation to spawn a plot...",
  );
