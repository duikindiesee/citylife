...
Bren Kalo: _"Taxes and wages make the treasury feel real. But if all surplus becomes girders and pipes, folk start
thinking the council sees us as machinery. A feast turns stored wealth into goodwill — it says the colony is not just
surviving, it belongs to us. Let the council buy one honest cheer before the next brownout."_
...
- **Auto-call:** when a staffed Feast Deck stands, the treasury sits comfortably above the feast cost, no feast is
  ...
  a feast itself.
- Feast Deck: build ~12 materials + ~8 components + ~2 reels + a build crew of 3; run 2 stewards. _(Bren asked for a
