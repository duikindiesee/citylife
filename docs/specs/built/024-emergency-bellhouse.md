...
rigs, alarm drones — for the day something finally goes wrong."_
...
- The Bellhouse answers _sudden crises only_ — it does **not** fix ordinary wear; the Maintenance Sheds (022)
...
- Cost: build ~16 materials + ~12 components + ~2 reels + a build crew of 3; run 2 response crew. _(Mara asked for a
  larger 12-worker station with structural panels and 4 reels; v1 uses the colony's standard service sizing and
  keeps her 2-concurrent-crew capacity — a bigger station is a later refinement.)_
