...
Mara Venn: _"We can sell our surplus, but one broken chain or a bad labour shift still stalls the whole colony. Landing One needs a controlled way to buy a critical shortage — without making honest local work pointless."_
...
- To BUILD: treasury + **~22 materials + ~10 components + a build crew of ~4** free colonists. _(Mara asked for 40 materials, 8 components, a 6-strong build crew and 10 clerks and haulers; v1 maps her harbour onto the colony's scale — a sizable trade hall run by a small office — with the larger crew a later refinement.)_
