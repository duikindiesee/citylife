...
Mara Venn: _"From above the whole island looks the same. Build a **Civic Pulse Survey Office** and we can
finally SEE which neighbourhoods thrive and which starve — cool where they're served, hot where they're
not. Then we stop wasting buildings and fix the districts that are actually hurting."_
