...
Juno Kest: _"We can feed, teach, heal, and entertain every house we raise — but soon there will be nowhere left to raise them. Space is the true ceiling over Landing One now, and a sky-colony that cannot widen its deck is only waiting to become crowded and brittle."_
...
- To BUILD the Works: treasury + **~48 materials + ~12 components + a build crew** of free colonists, run by **~6 staff** (deckwrights + riggers). _(Juno's figures; v1 may scale them to the colony — a substantial works, not a cheap shed, because making land is the colony's biggest undertaking after the Spire.)_
