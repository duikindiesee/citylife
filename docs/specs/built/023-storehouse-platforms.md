...
Mara Venn: _"I'm tired of 'infinite stock' hiding bad planning. Right now the mines, workshops, farms and the
...
crop dip, a reel-demand spike, an export run or a repair surge actually matters."_
...
- When production, trade or training would push a resource **above its cap**, the excess is **lost** — clamped
  ...
  go overboard.
- Storage is **colony-wide capacity** (v1), not per-tile. It is a _logistics_ mechanic, not another
...
- _(Mara asked for a 60-material, 12-worker, 400-unit platform; v1 uses the colony's standard service sizing —
  a bigger platform and player-set per-resource splits are later refinements.)_
