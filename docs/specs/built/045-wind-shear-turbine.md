...
Brannic Sore: _"Solar has carried us this far, but every new deck and Tier 3 block leans harder on the same fixed sun. If Landing One is going to widen without living under permanent brownout rules, we need a buildable generator that grows with the colony."_
