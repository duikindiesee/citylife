...
- Culture's pull on settlers is **full only when the colony has reels** to feed its theatres. When reels
  run dry, the culture immigration bonus (spec 010) is **halved** — the halls go dark.
- This is the colony's first **internal demand** for a luxury good, and a genuine tension with exporting
  reels (spec 012): ship them for treasury, or burn them for culture and growth. A rich colony does both,
...
- Each theatre consumes **~0.5 reels/day**, drawn from the stockpile (like the component upkeep of other
  services).
- Culture **fuel factor**: theatres + reels in stock → ×1.0 (full culture); theatres + reels at zero →
...
- Tests: reel-fed theatres yield the full culture factor; starved theatres yield the reduced factor;
  staffed theatres consume reels from the stockpile.
